...
export const PRICE_RANGE_SELECTOR="PRICE_RANGE_SELECTOR"
export const ORDER_BY_PRICE = "ORDER_BY_PRICE";
export const GET_PUNCTUATION= "GET_PUNCTUATION";
export const POST_PUNCTUATION= "POST_PUNCTUATION";
...
export const PUT_ROL_USER = "PUT_ROL_USER";
export const PUT_STATE_USER = "PUT_STATE_USER";
